...
with(this){return _c('ul',[_c('li',[_v("Tertiary Teacher/Educator")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("requires a tool to keep communication organised across large groups")]),_v(" "),_c('li',[_v("requires support for efficient tracking of academic progress")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": save important time through simplification of student-parent contact management, enhancement in communication tracking and integrated progress reports")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new teacher")]),_v(" "),_c('td',[_v("add a contact")]),_v(" "),_c('td',[_v("keep track of them")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("teacher")]),_v(" "),_c('td',[_v("delete a contact")]),_v(" "),_c('td',[_v("remove contacts that I no longer need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("teacher")]),_v(" "),_c('td',[_v("add a grade to a contact")]),_v(" "),_c('td',[_v("keep track of a student's grades")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("teacher")]),_v(" "),_c('td',[_v("add a student's details")]),_v(" "),_c('td',[_v("keep track of the students under me")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("teacher")]),_v(" "),_c('td',[_v("edit a contact")]),_v(" "),_c('td',[_v("correct a mistake made without having to delete it")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("teacher")]),_v(" "),_c('td',[_v("search for a contact")]),_v(" "),_c('td',[_v("find the contact I am looking for without having to scroll")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("add tags or labels to contacts")]),_v(" "),_c('td',[_v("group the many contacts that are in the application by a commonality")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("filter contacts by labels or tags")]),_v(" "),_c('td',[_v("filter out irrelevant contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("mass add contacts")]),_v(" "),_c('td',[_v("add a group of contacts without having to do so one by one")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("mass delete contacts")]),_v(" "),_c('td',[_v("delete multiple contacts without having to do so one by one")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("teacher")]),_v(" "),_c('td',[_v("add next of kins' contacts")]),_v(" "),_c('td',[_v("contact the relevant individual in case of emergencies")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("do custom sorts for contacts")]),_v(" "),_c('td',[_v("shift relevant contacts near the top of the list of contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("new teacher")]),_v(" "),_c('td',[_v("see guided tours and tooltips")]),_v(" "),_c('td',[_v("familiarise myself with the application interface")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("long-time teacher")]),_v(" "),_c('td',[_v("archive contacts")]),_v(" "),_c('td',[_v("reduce clutter in the application without permanently deleting the contact")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("long-time teacher")]),_v(" "),_c('td',[_v("refactor tags or labels")]),_v(" "),_c('td',[_v("mass edit tags or labels if any changes occur")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("new teacher")]),_v(" "),_c('td',[_v("see the application populated with sample data")]),_v(" "),_c('td',[_v("see what the application interface looks like")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("add descriptions to contacts")]),_v(" "),_c('td',[_v("be reminded of various traits a particular individual might have")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("frequent teacher")]),_v(" "),_c('td',[_v("undo previous action")]),_v(" "),_c('td',[_v("undo a mistake without having to delete or edit any contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("long-time teacher")]),_v(" "),_c('td',[_v("export contact data")]),_v(" "),_c('td',[_v("have a backup data file in case anything happens to the application")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("long-time teacher")]),_v(" "),_c('td',[_v("import contact data")]),_v(" "),_c('td',[_v("load data from a file to restore lost or missing data")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("long-time teacher")]),_v(" "),_c('td',[_v("access communication history")]),_v(" "),_c('td',[_v("well-prepared for upcoming meetings")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC01 - Add a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add a student to the list of contacts")])]),_v(" "),_c('li',[_c('p',[_v("User enters details of student they wish to add to the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the student and updates the list of contacts to include the added student")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The given data is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 - Find a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Preconditions: The list of contacts is not empty")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User enters a description of the student they wish to find")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook returns a list of students that fits the description")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The given data is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("2a. No student in the list fits the given description.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - Add a grade for a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User "),_c('u',[_v("finds the student they wish to add a grade for (UC02)")])])]),_v(" "),_c('li',[_c('p',[_v("User sends a request to AddressBook to add a grade for the student in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the grade for the student and updates the list of contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User is unable to find the student.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("2a. The given data is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. AddressBook shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC04 - Delete a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User "),_c('u',[_v("finds the student they wish to delete from the list (UC02)")])])]),_v(" "),_c('li',[_c('p',[_v("User sends a request to AddressBook to delete the student in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the student and updates the list of contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Edit a student's details")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User "),_c('u',[_v("finds the student they wish to edit (UC02)")])])]),_v(" "),_c('li',[_c('p',[_v("User sends a request to AddressBook to edit the details of the student in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook edits the student's details and updates the list of contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Add a tag to a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User "),_c('u',[_v("finds the student they wish to edit (UC02)")])])]),_v(" "),_c('li',[_c('p',[_v("User sends a request to AddressBook to add a tag to the student in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the tag to the student and updates the list of contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC07 - Add contacts of next-of-kins of a student")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User "),_c('u',[_v("finds the student they wish to add contacts of next-of-kins for (UC02)")])])]),_v(" "),_c('li',[_c('p',[_v("User sends a request to AddressBook to add contacts of next-of-kins of the student in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook adds the contacts and updates the list of contacts")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Data Requirements")]),_v(" "),_c('ul',[_c('li',[_v("EduContacts must be capable of storing up to 1000 students’ contact details and academic data without significant performance degradation")]),_v(" "),_c('li',[_v("Contact and student data will not change frequently, but updates must be handled seamlessly (e.g., adding, updating, or deleting student details).")])])]),_v(" "),_c('li',[_c('strong',[_v("Portability")]),_v(" "),_c('ul',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("EduContacts must be packaged in a single JAR file (or ZIP if additional resources are required). It should not require installation, making it easy to use on any system that supports Java 17.")]),_v(" "),_c('li',[_v("All data must be stored locally in human-readable text files, making it easy to back up or transfer data between systems.")])])]),_v(" "),_c('li',[_c('strong',[_v("Scalability")]),_v(" "),_c('ul',[_c('li',[_v("The system should be designed with extensibility in mind, allowing new features (e.g., tracking student behavior) to be added without significantly altering the existing codebase.")]),_v(" "),_c('li',[_v("The system should be capable of supporting more than 1000 contacts if needed, with the ability to upgrade to handle larger datasets without performance degradation.")])])]),_v(" "),_c('li',[_c('strong',[_v("Accessibility")]),_v(" "),_c('ul',[_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The user interface should be accessible to users with disabilities, adhering to standard accessibility guidelines to accommodate screen readers and keyboard navigation.")]),_v(" "),_c('li',[_v("The system should be easy to use for educators, with a simple CLI for fast input and an intuitive GUI for viewing contact information and reports.")])])]),_v(" "),_c('li',[_c('strong',[_v("Efficiency")]),_v(" "),_c('ul',[_c('li',[_v("The system should respond within 1 second for typical operations (e.g., adding a student, searching for a contact) with up to 1000 records. For larger datasets, response time should not exceed 3 seconds.")]),_v(" "),_c('li',[_v("Operations such as adding, deleting, and modifying student details should not cause noticeable performance degradation, even as the dataset grows.")])])]),_v(" "),_c('li',[_c('strong',[_v("Documentation")]),_v(" "),_c('ul',[_c('li',[_v("The system should include comprehensive documentation for both command-line and GUI operations, along with access to user support for troubleshooting and guidance.")]),_v(" "),_c('li',[_v("The codebase should be documented for future developers, making it easy to maintain, debug, and extend the system.")])])]),_v(" "),_c('li',[_c('strong',[_v("Robustness")]),_v(" "),_c('ul',[_c('li',[_v("The system must provide informative error messages for incorrect input or failures (e.g., invalid student ID).")]),_v(" "),_c('li',[_v("The system should not crash unexpectedly, and all errors must be logged for debugging.")])])]),_v(" "),_c('li',[_c('strong',[_v("Security")]),_v(" "),_c('ul',[_c('li',[_v("A login page should be implemented in order to prevent unauthorised users from signing in to other accounts.")]),_v(" "),_c('li',[_v("Student and parent data should be encrypted to prevent unauthorized access, while still being editable by advanced users.")])])]),_v(" "),_c('li',[_c('strong',[_v("Testability")]),_v(" "),_c('ul',[_c('li',[_v("The system should be compatible with automated testing frameworks, and all major features should be covered by unit and integration tests.")]),_v(" "),_c('li',[_v("All features should be easy to test manually without requiring complex setups.")])])]),_v(" "),_c('li',[_c('strong',[_v("Reliability")]),_v(" "),_c('ul',[_c('li',[_v("The application must be reliable and available for use during critical hours, such as during class or exam periods, without crashing or losing data.")])])]),_v(" "),_c('li',[_c('strong',[_v("Compliance")]),_v(" "),_c('ul',[_c('li',[_v("EduContacts must comply with relevant data protection laws (e.g., GDPR, PDPA) to ensure student and parent information is stored securely and is accessible only by authorized users.")]),_v(" "),_c('li',[_v("The system should provide options to manage and delete student data upon request, to comply with legal requirements.")])])]),_v(" "),_c('li',[_c('strong',[_v("Interoperability")]),_v(" "),_c('ul',[_c('li',[_v("EduContacts should be able to sync data with external platforms, such as Coursemology or Canvas, through API or manual import/export mechanisms.")]),_v(" "),_c('li',[_v("The system should support exporting and importing data in common file formats (e.g., CSV) for ease of use and integration.")])])]),_v(" "),_c('li',[_c('strong',[_v("Disaster Recovery")]),_v(" "),_c('ul',[_c('li',[_v("The system should support manual and automatic backups to prevent data loss. In case of a critical failure, the data should be easily recoverable.")]),_v(" "),_c('li',[_v("There should be clear steps for restoring data from a backup after a system failure, ensuring minimal downtime.")])])]),_v(" "),_c('li',[_c('strong',[_v("Fault Tolerance")]),_v(" "),_c('ul',[_c('li',[_v("All critical errors should be logged, allowing developers to troubleshoot and resolve issues. Minor errors should not crash the system but allow users to continue their tasks.")]),_v(" "),_c('li',[_v("In the event of a system fault, the system should continue operating in a degraded mode without losing functionality.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Command-line Interface (CLI)")]),_v(": A text-based interface used to interact with the software by typing commands. It is preferred by users who can type quickly and need to perform tasks efficiently without relying on graphical elements.")]),_v(" "),_c('li',[_c('strong',[_v("Graphical User Interface (GUI)")]),_v(": The visual component of EduContacts where users can interact with the application through graphical elements (e.g., buttons, forms) rather than text-based commands.")]),_v(" "),_c('li',[_c('strong',[_v("JAR File")]),_v(": A Java Archive (JAR) file that contains the EduContacts application. This single file allows the program to be executed on any machine that supports Java 17, without needing installation.")]),_v(" "),_c('li',[_c('strong',[_v("Human-readable File")]),_v(": A text file that can be easily opened, read, and understood by a person. Typically, such files are plain text and do not require specialized software to interpret or modify.")]),_v(" "),_c('li',[_c('strong',[_v("JavaScript Object Notation (JSON)")]),_v(": A lightweight, text-based format for representing structured data. It is used to exchange data between a server and a web application or store configuration settings.")]),_v(" "),_c('li',[_c('strong',[_v("Comma-Separated Values (CSV)")]),_v(": A plain-text file format used to store tabular data (numbers and text) in a structured way. Each line of the file corresponds to a row in the table, and the values are separated by commas (or other delimiters like semicolons or tabs).")]),_v(" "),_c('li',[_c('strong',[_v("Duplicate Entry")]),_v(": A situation where a student or contact already exists in the address book based on a matching unique identifier (e.g., Student ID). In such cases, EduContacts will reject the duplicate entry and display an error message.")]),_v(" "),_c('li',[_c('strong',[_v("Error Message")]),_v(": A notification provided to the user when an invalid input or action is detected. For example, entering a student ID in the wrong format will prompt an error message such as \"Please enter a valid student ID!\"")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 3 Oct 2024, 23:42:37 GMT+8]")])])])}
}];
